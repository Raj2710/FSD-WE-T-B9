...
function CreateBlog() {
  ...
  const handleImageUpload = async(e)=>{
    ...
    {
      toast.error(`Only ${allowedFormat.join(",")} formats are allowed and size should be less than 1 mb`)
    }
  }
  ...
  <div className='create-blog-wrapper'>
    ...
    <Form>
      ...
      <Form.Group className="mb-3">
        ...
        <Form.Control type="text" placeholder="Description" as="textarea" onChange={(e)=>setdesc(e.target.value)}/>
      </Form.Group>
    
      <Button variant="primary" onClick={()=>postBlog()}>
        Post my blog!
      </Button>
    </Form>
    </div>
